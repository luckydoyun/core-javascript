...
// conversationTool.name = 'LG';

console.log('conversationTool : ', conversationTool);
...
function objectCopy(originObject, copyObject ) {
...
// let copycontainerStyles = [...containerStyles];
