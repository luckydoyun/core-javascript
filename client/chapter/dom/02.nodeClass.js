...
// - nodeType
console.log('first.nodeType : ', first.nodeType);
console.log('first.nodeType === document.ELEMENT_NODE : ' ,first.nodeType === document.ELEMENT_NODE);
// - nodeName (vs. tagName)
console.log('first.nodeName : ', first.nodeName);
console.log('first.tagName : ', first.tagName);
...
// - innerHTML
first.innerHTML += 'D O Y U N';
// * 기존 내용 삭제
first.innerHTML = '';
// * 기존 내용과 새로운 내용을 합친 새로운 내용을 씀
first.innerHTML += '<string>like lion</string>';
