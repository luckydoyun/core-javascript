...
const createUserCard = ({
  ...
  name = '',
  email = '',
  website = 'not-open-site',
}) => {

  // const {id, name, email, website = 'not-open-site'} = user;
  ...
  <section class="user-card-inner">
    <article class="user-card" data-index="user-${id}">
      ...
      <div class="user-resouce-info">
        ...
        <div>
          <a class="user-website" href="http://${website}" target="_blank" 
...
const createEmptyCard = (size = 200, emptyMessage = '데이터가 없습니다.') =>{
  return /* html */`
